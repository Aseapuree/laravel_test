                            ...
                            <div class="col-lg-10">
                                ...
                                <div class="hero-content">
                                    ...
                                    <div class="hero-button" data-animation="fadeInUp" data-delay="1.7s">
                                        ...
                                        <a href="{{ route('shop') }}" class="theme-btn">Ver productos<i class="fa-regular fa-arrow-right"></i></a>
                            ...
                            <div class="col-lg-10">
                                ...
                                <div class="hero-content">
                                    ...
                                    <div class="hero-button" data-animation="fadeInUp" data-delay="1.7s">
                                        ...
                                        <a href="{{ route('shop') }}" class="theme-btn">Compra Ahora<i class="fa-regular fa-arrow-right"></i></a>
                            ...
                            <div class="col-lg-10">
                                ...
                                <div class="hero-content">
                                    ...
                                    <div class="hero-button" data-animation="fadeInUp" data-delay="1.7s">
                                        ...
                                        <a href="{{ route('shop') }}" class="theme-btn">Explorar productos<i class="fa-regular fa-arrow-right"></i></a>
